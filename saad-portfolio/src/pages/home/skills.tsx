...
const skillsData: Skill[] = [
    ...
    {name: 'HTML5', icon: faHtml5, link: 'https://developer.mozilla.org/en-US/docs/Glossary/HTML5', className: styles.skillsIconC},
    {name: 'CSS3', icon: faCss3Alt, link: 'https://developer.mozilla.org/en-US/docs/Web/CSS', className: styles.skillsIconD},
